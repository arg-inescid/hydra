...
public class GraalVisor {
    ...
    public interface GraalVisorStruct extends PointerBase {
        ...
        @CField("f_host_execute_db_method")
        HostExecuteDBMethodFunctionPointer getHostExecuteDBMethodFunction();

        @CField("f_host_execute_db_method")
        void setHostExecuteDBMethodFunction(HostExecuteDBMethodFunctionPointer executeDBMethodFunction);
    }
