...
curl -X POST $HYDRA_ADDRESS/register?name=test\&language=java\&entrypoint=com.uploader.Uploader\&isBinary=true\&svmid=2\&sandbox=context-snapshot\&url=http://172.18.0.1:8000/apps/gv-js-uploader.so
