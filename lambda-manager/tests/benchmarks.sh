...
BENCHMARK_SANDBOXES[hy_js_hw]="snapshot-process"
BENCHMARK_SANDBOXES[hy_js_dh]="snapshot-process"
BENCHMARK_SANDBOXES[hy_js_th]="process"
BENCHMARK_SANDBOXES[hy_js_up]="process"

BENCHMARK_SANDBOXES[hy_py_hw]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_ms]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_bf]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_pr]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_dn]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_dh]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_co]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_th]="snapshot-process"
BENCHMARK_SANDBOXES[hy_py_vp]="process"
BENCHMARK_SANDBOXES[hy_py_up]="snapshot-process"
