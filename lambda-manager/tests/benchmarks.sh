...
GV_JV_BENCHMARKS=(gv_jv_hw  gv_jv_fh  gv_jv_cl  gv_jv_hr  gv_jv_vp)
GV_PY_BENCHMARKS=(gv_py_hw  gv_py_ms  gv_py_bf  gv_py_pr  gv_py_dn  gv_py_dh  gv_py_co  gv_py_th  gv_py_vp  gv_py_up)
# GV_JS_BENCHMARKS=(gv_js_hw  gv_js_dh  gv_js_th  gv_js_up)
GV_JS_BENCHMARKS=(gv_js_hw  gv_js_dh  gv_js_up)
GV_BENCHMARKS=("${GV_JV_BENCHMARKS[@]}" "${GV_PY_BENCHMARKS[@]}" "${GV_JS_BENCHMARKS[@]}")
...
BENCHMARK_CODE[gv_jv_hw]="$DATA_ADDRESS/apps/gv-jv-hello-world.so"
BENCHMARK_CODE[gv_jv_fh]="$DATA_ADDRESS/apps/gv-jv-file-hashing.so"
BENCHMARK_CODE[gv_jv_cl]="$DATA_ADDRESS/apps/gv-jv-classify.zip"
BENCHMARK_CODE[gv_jv_hr]="$DATA_ADDRESS/apps/gv-jv-httprequest.so"
BENCHMARK_CODE[gv_jv_vp]="$DATA_ADDRESS/apps/gv-jv-video-processing.so"

BENCHMARK_CODE[gv_js_hw]="$DATA_ADDRESS/apps/gv-js-hello-world.so"
BENCHMARK_CODE[gv_js_dh]="$DATA_ADDRESS/apps/gv-js-dynamic-html.so"
BENCHMARK_CODE[gv_js_th]="$DATA_ADDRESS/apps/gv-js-thumbnail.zip"
BENCHMARK_CODE[gv_js_up]="$DATA_ADDRESS/apps/gv-js-uploader.so"

BENCHMARK_CODE[gv_py_hw]="$DATA_ADDRESS/apps/gv-py-hello-world.so"
BENCHMARK_CODE[gv_py_ms]="$DATA_ADDRESS/apps/gv-py-mst.so"
BENCHMARK_CODE[gv_py_bf]="$DATA_ADDRESS/apps/gv-py-bfs.so"
BENCHMARK_CODE[gv_py_pr]="$DATA_ADDRESS/apps/gv-py-pagerank.so"
BENCHMARK_CODE[gv_py_dn]="$DATA_ADDRESS/apps/gv-py-dna.so"
BENCHMARK_CODE[gv_py_dh]="$DATA_ADDRESS/apps/gv-py-dynamic-html.so"
BENCHMARK_CODE[gv_py_co]="$DATA_ADDRESS/apps/gv-py-compression.so"
BENCHMARK_CODE[gv_py_th]="$DATA_ADDRESS/apps/gv-py-thumbnail.so"
BENCHMARK_CODE[gv_py_vp]="$DATA_ADDRESS/apps/gv-py-video-processing.so"
BENCHMARK_CODE[gv_py_up]="$DATA_ADDRESS/apps/gv-py-uploader.so"


declare -A BENCHMARK_ENTRYPOINTS
BENCHMARK_ENTRYPOINTS[gv_jv_hw]="com.hello_world.HelloWorld"
BENCHMARK_ENTRYPOINTS[gv_jv_fh]="com.filehashing.FileHashing"
BENCHMARK_ENTRYPOINTS[gv_jv_cl]="com.classify.Classify"
BENCHMARK_ENTRYPOINTS[gv_jv_hr]="com.httprequest.HttpRequest"
BENCHMARK_ENTRYPOINTS[gv_jv_vp]="com.videoprocessing.VideoProcessing"

BENCHMARK_ENTRYPOINTS[gv_js_hw]="com.helloworld.HelloWorld"
BENCHMARK_ENTRYPOINTS[gv_js_dh]="com.dynamichtml.DynamicHTML"
BENCHMARK_ENTRYPOINTS[gv_js_th]="com.thumbnail.Thumbnail"
BENCHMARK_ENTRYPOINTS[gv_js_up]="com.uploader.Uploader"

BENCHMARK_ENTRYPOINTS[gv_py_hw]="com.helloworld.HelloWorld"
BENCHMARK_ENTRYPOINTS[gv_py_ms]="com.mst.MST"
BENCHMARK_ENTRYPOINTS[gv_py_bf]="com.bfs.BFS"
BENCHMARK_ENTRYPOINTS[gv_py_pr]="com.pr.PageRank"
BENCHMARK_ENTRYPOINTS[gv_py_dn]="com.dna.DNA"
BENCHMARK_ENTRYPOINTS[gv_py_dh]="com.dynamichtml.DynamicHTML"
BENCHMARK_ENTRYPOINTS[gv_py_co]="com.compression.Compression"
BENCHMARK_ENTRYPOINTS[gv_py_th]="com.thumbnail.Thumbnail"
BENCHMARK_ENTRYPOINTS[gv_py_vp]="com.videoprocessing.VideoProcessing"
BENCHMARK_ENTRYPOINTS[gv_py_up]="com.uploader.Uploader"


declare -A BENCHMARK_PAYLOADS
BENCHMARK_PAYLOADS[gv_jv_hw]='{}'
BENCHMARK_PAYLOADS[gv_jv_fh]='{"url":"'$DATA_ADDRESS'/snap.png"}'
BENCHMARK_PAYLOADS[gv_jv_cl]='{"model_url":"'$DATA_ADDRESS'/tensorflow_inception_graph.pb","labels_url":"'$DATA_ADDRESS'/imagenet_comp_graph_label_strings.txt","image_url":"'$DATA_ADDRESS'/eagle.jpg"}'
BENCHMARK_PAYLOADS[gv_jv_hr]='{"url":"'$DATA_ADDRESS'/snap.png"}'
BENCHMARK_PAYLOADS[gv_jv_vp]='{"video":"'$DATA_ADDRESS'/video.mp4","ffmpeg":"'$DATA_ADDRESS'/ffmpeg"}'

BENCHMARK_PAYLOADS[gv_js_hw]='{}'
BENCHMARK_PAYLOADS[gv_js_dh]='{"url":"'$DATA_ADDRESS'/template.html","username":"rbruno","nsize":"10"}'
BENCHMARK_PAYLOADS[gv_js_th]='{"url":"'$DATA_ADDRESS'/snap.png"}'
BENCHMARK_PAYLOADS[gv_js_up]='{"url":"'$DATA_ADDRESS'/snap.png"}'

BENCHMARK_PAYLOADS[gv_py_hw]='{}'
BENCHMARK_PAYLOADS[gv_py_ms]='{"size":"100"}'
BENCHMARK_PAYLOADS[gv_py_bf]='{"size":"100"}'
BENCHMARK_PAYLOADS[gv_py_pr]='{"size":"10"}'
BENCHMARK_PAYLOADS[gv_py_dn]='{"fasta_url":"'$DATA_ADDRESS'/bacillus_subtilis.fasta"}'
BENCHMARK_PAYLOADS[gv_py_dh]='{"url":"'$DATA_ADDRESS'/template.html","username":"rbruno","nsize":"10"}'
BENCHMARK_PAYLOADS[gv_py_co]='{"url":"'$DATA_ADDRESS'/video.mp4"}'
BENCHMARK_PAYLOADS[gv_py_th]='{"url":"'$DATA_ADDRESS'/snap.png"}'
BENCHMARK_PAYLOADS[gv_py_vp]='{"video":"'$DATA_ADDRESS'/video.mp4","ffmpeg":"'$DATA_ADDRESS'/ffmpeg"}'
BENCHMARK_PAYLOADS[gv_py_up]='{"url":"'$DATA_ADDRESS'/snap.png"}'
...
BENCHMARK_SANDBOXES[gv_js_hw]="snapshot-process"
BENCHMARK_SANDBOXES[gv_js_dh]="snapshot-process"
BENCHMARK_SANDBOXES[gv_js_th]="process"
BENCHMARK_SANDBOXES[gv_js_up]="process"

BENCHMARK_SANDBOXES[gv_py_hw]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_ms]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_bf]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_pr]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_dn]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_dh]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_co]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_th]="snapshot-process"
BENCHMARK_SANDBOXES[gv_py_vp]="process"
BENCHMARK_SANDBOXES[gv_py_up]="snapshot-process"


declare -A BENCHMARK_SVMIDS
BENCHMARK_SVMIDS[gv_jv_hw]=
BENCHMARK_SVMIDS[gv_jv_fh]=
BENCHMARK_SVMIDS[gv_jv_cl]=
BENCHMARK_SVMIDS[gv_jv_hr]=
BENCHMARK_SVMIDS[gv_jv_vp]=

BENCHMARK_SVMIDS[gv_js_hw]="1"
BENCHMARK_SVMIDS[gv_js_dh]="2"
BENCHMARK_SVMIDS[gv_js_th]="3"
BENCHMARK_SVMIDS[gv_js_up]="4"

BENCHMARK_SVMIDS[gv_py_hw]="5"
BENCHMARK_SVMIDS[gv_py_ms]="6"
BENCHMARK_SVMIDS[gv_py_bf]="7"
BENCHMARK_SVMIDS[gv_py_pr]="8"
BENCHMARK_SVMIDS[gv_py_dn]="9"
BENCHMARK_SVMIDS[gv_py_dh]="10"
BENCHMARK_SVMIDS[gv_py_co]="11"
BENCHMARK_SVMIDS[gv_py_th]="12"
BENCHMARK_SVMIDS[gv_py_vp]="13"
BENCHMARK_SVMIDS[gv_py_up]="14"
