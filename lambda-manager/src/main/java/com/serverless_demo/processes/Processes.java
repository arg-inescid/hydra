...
import com.serverless_demo.processes.main.BuildNativeImage;
import com.serverless_demo.processes.main.CreateTap;
import com.serverless_demo.processes.main.RemoveTaps;
import com.serverless_demo.processes.start_lambda.*;
import com.serverless_demo.processes.start_lambda.impl.StartHotspot;
import com.serverless_demo.processes.start_lambda.impl.StartHotspotWithAgent;
import com.serverless_demo.processes.start_lambda.impl.StartHotspotWithBuildNativeImage;
import com.serverless_demo.processes.start_lambda.impl.StartNativeImage;
