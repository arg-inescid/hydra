...
public interface LanguageEngine {
     ...
     */
    String invoke(String functionName, String jsonArguments) throws InvocationTargetException, IllegalAccessException, IOException, ClassNotFoundException, NoSuchMethodException;
     ...
     */
    default void registerFunction(String functionName, IsolateObjectWrapper targetIsolate) throws Exception {
