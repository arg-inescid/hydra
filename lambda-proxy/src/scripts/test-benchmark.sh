...
function cr_python_thumbnail {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-thumbnail/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-thumbnail/run.json
}
...
function cr_javascript_thumbnail {
	IMG=docker.io/openwhisk/action-nodejs-v12:latest
	INIT_POST=$ARGO_BENCHMARKS/language/javascript/cr-thumbnail/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/javascript/cr-thumbnail/run.json
}
...
function cr_java_sleep {
	IMG=docker.io/openwhisk/java8action:latest
	INIT_POST=$ARGO_BENCHMARKS/language/java/cr-sleep/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/java/cr-sleep/run.json
}
...
function cr_python_sleep {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-sleep/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-sleep/run.json
}
...
function cr_javascript_sleep {
	IMG=docker.io/openwhisk/action-nodejs-v12:latest
	INIT_POST=$ARGO_BENCHMARKS/language/javascript/cr-sleep/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/javascript/cr-sleep/run.json
}
...
function cr_java_filehashing {
	IMG=docker.io/openwhisk/java8action:latest
	INIT_POST=$ARGO_BENCHMARKS/language/java/cr-file-hashing/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/java/cr-file-hashing/run.json
}
...
function cr_java_httprequest {
	IMG=docker.io/openwhisk/java8action:latest
	INIT_POST=$ARGO_BENCHMARKS/language/java/cr-httprequest/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/java/cr-httprequest/run.json
}
...
function cr_java_videoprocessing {
	IMG=docker.io/openwhisk/java8action:latest
	INIT_POST=$ARGO_BENCHMARKS/language/java/cr-video-processing/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/java/cr-video-processing/run.json
}
...
function cr_python_videoprocessing {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-video-processing/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-video-processing/run.json
}
...
function cr_python_compression {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-compression/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-compression/run.json
}
...
function cr_javascript_dynamichtml {
	IMG=docker.io/openwhisk/action-nodejs-v12:latest
	INIT_POST=$ARGO_BENCHMARKS/language/javascript/cr-dynamic-html/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/javascript/cr-dynamic-html/run.json
}

function gv_python_dynamichtml {
	APP_SCRIPT=$ARGO_BENCHMARKS/language/python/gv-dynamic-html/main.py
	APP_LANG=python
	APP_MAIN=main
	curl -s -X POST $ip:8080/register?name=dynamichtml\&entryPoint=$APP_MAIN\&language=$APP_LANG -H 'Content-Type: application/json' --data-binary @$APP_SCRIPT
	echo '{"name":"dynamichtml","async":"false","arguments":"http://127.0.0.1:8000/template.html;rbruno;1000"}' > $APP_POST
...
function cr_python_dynamichtml {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-dynamic-html/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-dynamic-html/run.json
}

function gv_python_uploader {
	APP_SCRIPT=$ARGO_BENCHMARKS/language/python/gv-uploader/main.py
	APP_LANG=python
	APP_MAIN=main
...
function cr_python_uploader {
	IMG=docker.io/openwhisk/action-python-v3.9:latest
	INIT_POST=$ARGO_BENCHMARKS/language/python/cr-uploader/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/python/cr-uploader/run.json
}


function gv_javascript_uploader {
	APP_SCRIPT=$ARGO_BENCHMARKS/language/javascript/gv-uploader/main.js
	APP_LANG=javascript
	APP_MAIN=main
	curl -s -X POST $ip:8080/register?name=uploader\&entryPoint=$APP_MAIN\&language=$APP_LANG -H 'Content-Type: application/json' --data-binary @$APP_SCRIPT
	echo '{"name":"uploader","async":"false","arguments":"http://127.0.0.1:8000/snap.png"}' > $APP_POST
...
function cr_javascript_uploader {
	IMG=docker.io/openwhisk/action-nodejs-v12:latest
	INIT_POST=$ARGO_BENCHMARKS/language/javascript/cr-uploader/init.json
	RUN_POST=$ARGO_BENCHMARKS/language/javascript/cr-uploader/run.json
}
