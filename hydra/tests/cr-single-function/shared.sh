...
BENCHMARK_REGISTER_QUERY[jvhw]="name=jvhw&language=java&entrypoint=com.hello_world.HelloWorld&sandbox=isolate&url=http://127.0.0.1:8000/apps/hy-jv-hello-world.so"
BENCHMARK_REGISTER_QUERY[jvfh]="name=jvfh&language=java&entrypoint=com.filehashing.FileHashing&sandbox=isolate&url=http://127.0.0.1:8000/apps/hy-jv-file-hashing.so"
BENCHMARK_REGISTER_QUERY[jvcy]="name=jvcy&language=java&entrypoint=com.classify.Classify&sandbox=process&url=http://127.0.0.1:8000/apps/hy-jv-classify.zip"
BENCHMARK_REGISTER_QUERY[jvhr]="name=jvhr&language=java&entrypoint=com.httprequest.HttpRequest&sandbox=isolate&url=http://127.0.0.1:8000/apps/hy-jv-httprequest.so"
BENCHMARK_REGISTER_QUERY[jvvp]="name=jvvp&language=java&entrypoint=com.videoprocessing.VideoProcessing&sandbox=process&url=http://127.0.0.1:8000/apps/hy-jv-video-processing.so"

BENCHMARK_REGISTER_QUERY[jshw]="name=jshw&language=javascript&entrypoint=com.helloworld.HelloWorld&svmid=1&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-js-hello-world.so"
BENCHMARK_REGISTER_QUERY[jsdh]="name=jsdh&language=javascript&entrypoint=com.dynamichtml.DynamicHTML&svmid=2&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-js-dynamic-html.so"
BENCHMARK_REGISTER_QUERY[jsup]="name=jsup&language=javascript&entrypoint=com.uploader.Uploader&svmid=4&sandbox=process&url=http://127.0.0.1:8000/apps/hy-js-uploader.so"
BENCHMARK_REGISTER_QUERY[jstn]="name=jstn&language=javascript&entrypoint=com.thumbnail.Thumbnail&sandbox=process&url=http://127.0.0.1:8000/apps/hy-js-thumbnail.zip"

BENCHMARK_REGISTER_QUERY[pyhw]="name=pyhw&language=python&entrypoint=com.helloworld.HelloWorld&svmid=5&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-hello-world.so"
BENCHMARK_REGISTER_QUERY[pymst]="name=pymst&language=python&entrypoint=com.mst.MST&svmid=6&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-mst.so"
BENCHMARK_REGISTER_QUERY[pybfs]="name=pybfs&language=python&entrypoint=com.bfs.BFS&svmid=7&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-bfs.so"
BENCHMARK_REGISTER_QUERY[pypr]="name=pypr&language=python&entrypoint=com.pr.PageRank&svmid=8&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-pagerank.so"
BENCHMARK_REGISTER_QUERY[pydna]="name=pydna&language=python&entrypoint=com.dna.DNA&svmid=9&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-dna.so"
BENCHMARK_REGISTER_QUERY[pydh]="name=pydh&language=python&entrypoint=com.dynamichtml.DynamicHTML&svmid=10&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-dynamic-html.so"
BENCHMARK_REGISTER_QUERY[pyco]="name=pyco&language=python&entrypoint=com.compression.Compression&svmid=11&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-compression.so"
BENCHMARK_REGISTER_QUERY[pytn]="name=pytn&language=python&entrypoint=com.thumbnail.Thumbnail&svmid=12&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-thumbnail.so"
BENCHMARK_REGISTER_QUERY[pyup]="name=pyup&language=python&entrypoint=com.uploader.Uploader&svmid=13&sandbox=snapshot-process&url=http://127.0.0.1:8000/apps/hy-py-uploader.so"
BENCHMARK_REGISTER_QUERY[pyvp]="name=pyvp&language=python&entrypoint=com.videoprocessing.VideoProcessing&sandbox=process&url=http://127.0.0.1:8000/apps/hy-py-video-processing.so"
