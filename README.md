...
- [lambda-proxies](https://github.com/graalvm-argo/core/blob/main/lambda-proxies/README.md) - Contains Serverless function wrappers that offer support for Native Image Isolates and Truffle Languages;
- [lambda-manager](https://github.com/graalvm-argo/core/blob/main/lambda-manager/README.md) - (this repository) The Lambda Manager is a core component of the Argo architecture. It manages the resources of a local node by launching and terminating VMs where functions run;
