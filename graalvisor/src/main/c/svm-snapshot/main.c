...
enum EXECUTION_MODE { NORMAL, CHECKPOINT, RESTORE , MINIMIZE, FROM_FILE};
...
int main(int argc, char** argv) {
    ...
    } else if (CURRENT_MODE == FROM_FILE) {
        process_instructions("example.config");
     } else {
        isolate_abi_t abi;
