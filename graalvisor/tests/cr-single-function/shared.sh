...
BENCHMARK_REGISTER_QUERY[jshw]="name=jshw&language=javascript&entrypoint=com.helloworld.HelloWorld&svmid=1&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-js-hello-world.so"
BENCHMARK_REGISTER_QUERY[jsdh]="name=jsdh&language=javascript&entrypoint=com.dynamichtml.DynamicHTML&svmid=2&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-js-dynamic-html.so"
BENCHMARK_REGISTER_QUERY[jsup]="name=jsup&language=javascript&entrypoint=com.uploader.Uploader&svmid=4&sandbox=context&url=http://127.0.0.1:8000/apps/gv-js-uploader.so"
BENCHMARK_REGISTER_QUERY[jstn]="name=jstn&language=javascript&entrypoint=com.thumbnail.Thumbnail&sandbox=context&url=http://127.0.0.1:8000/apps/gv-js-thumbnail.zip"

BENCHMARK_REGISTER_QUERY[pyhw]="name=pyhw&language=python&entrypoint=com.helloworld.HelloWorld&svmid=5&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-hello-world.so"
BENCHMARK_REGISTER_QUERY[pymst]="name=pymst&language=python&entrypoint=com.mst.MST&svmid=6&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-mst.so"
BENCHMARK_REGISTER_QUERY[pybfs]="name=pybfs&language=python&entrypoint=com.bfs.BFS&svmid=7&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-bfs.so"
BENCHMARK_REGISTER_QUERY[pypr]="name=pypr&language=python&entrypoint=com.pr.PageRank&svmid=8&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-pagerank.so"
BENCHMARK_REGISTER_QUERY[pydna]="name=pydna&language=python&entrypoint=com.dna.DNA&svmid=9&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-dna.so"
BENCHMARK_REGISTER_QUERY[pydh]="name=pydh&language=python&entrypoint=com.dynamichtml.DynamicHTML&svmid=10&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-dynamic-html.so"
BENCHMARK_REGISTER_QUERY[pyco]="name=pyco&language=python&entrypoint=com.compression.Compression&svmid=11&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-compression.so"
BENCHMARK_REGISTER_QUERY[pytn]="name=pytn&language=python&entrypoint=com.thumbnail.Thumbnail&svmid=12&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-thumbnail.so"
BENCHMARK_REGISTER_QUERY[pyup]="name=pyup&language=python&entrypoint=com.uploader.Uploader&svmid=13&sandbox=snapshot&url=http://127.0.0.1:8000/apps/gv-py-uploader.so"
BENCHMARK_REGISTER_QUERY[pyvp]="name=pyvp&language=python&entrypoint=com.videoprocessing.VideoProcessing&sandbox=context&url=http://127.0.0.1:8000/apps/gv-py-video-processing.so"
