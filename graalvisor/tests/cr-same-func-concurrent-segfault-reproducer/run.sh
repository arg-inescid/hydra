...
# # Overriding start/stop functions to use containers.
# function start_hydra {
#     export app_dir=$(pwd)/apps
#     mkdir -p $app_dir
#     sudo chown -R root:root $app_dir

#     docker run --privileged --rm --name=bcontainer --network host -v $app_dir:/tmp/apps -e lambda_port="$HYDRA_PORT" graalvisor:latest &>> graalvisor.log &
